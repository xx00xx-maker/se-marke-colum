...
${isBoardMode ? `# 3パターンの差別化（書き出しだけでなく構成全体を変えること）
...
- **厳守**: 冒頭から一貫して**女性読者の願望・欲求を問いかける形**で書くこと。最初の一文から女性に向けて話しかけること
...
**3パターンは同じテーマでも、切り口・構成・文章のリズムがまったく異なるものにしてください。**` : `# 3パターンの差別化（同じ体験でも切り口・視点を変えること）

## パターン1: 体験詳細型
- **視点**: 出来事を時系列で丁寧に描写する。場所・時間・相手の雰囲気・香り・感触など五感を使って臨場感を出す
- **書き出し**: 日付や状況設定から入る。「〇月〇日、〜」「先日、〜」など
- **特徴**: 細部の描写にこだわる。読者が映像として想像できる具体性。感情より行為・状況の描写が中心

## パターン2: 感情・心理重視型
- **視点**: 体験中の心理状態・感情の変化を中心に書く。緊張→高まり→解放の流れ
- **書き出し**: 感情や印象から入る。「あの時の感覚が忘れられない」「〜という言葉が頭に残っている」など
- **特徴**: 内面の独白が多め。「〜と思った」「〜な気持ちになった」など心の声を丁寧に描く

## パターン3: じらし・余韻型
- **視点**: 全部を語らず、焦らしと余白を意識して書く。読者の想像力を刺激する
- **書き出し**: 結末や印象的な一場面から入り、そこに至る経緯を後から描く
- **特徴**: 途中で文章を切る、曖昧な表現で想像させる、次回への期待感で締める

**3パターンは同じ体験を題材にしても、語り口・構成・焦点がまったく異なるものにしてください。**`}
